...
The ratio between overall number of articles and those articles mentioning the term "experiment\*" ranged between `r exp_ratio_min` and `r exp_ratio_max` (with a median of `r exp_ratio_median`).
...
This mentioning rate is comparable to the 1.6\% that @makel_replications_2012 have reported on in their study on psychology. <!--KK: Shouldn't that be only mentioned in the discussion as it's already (kind of) interpreting?-->
...
<!--KK: further things that were not preregistered: took the first mentioned study if there were several self-labeled replications, took the independent study if there were also inner-paper studies, make more clear that the explicit aim to replicate a previous study had to be mentioned-->
