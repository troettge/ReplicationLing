...
```{r topten-plot, fig.align = 'center', fig.width = 5, fig.height = 7.5, fig.cap = "Variation in rate of replicat* mention across those journals that exhibited at least one mention of the term. Numeric values on the right indicate the observed proportion of articles containing the string experiment* in title, abstract or keywords."}
...
FitFlextableToPage <- function(ft, pgwidth = 4.6){
...
FitFlextableToPage(appendix)
#set_table_properties(appendix, width = .75, layout = "fixed")
#appendix
```
