...
In other words, our sample included a single independent failed replication attempt.
...
Only a minority of replications targeted a different language than the initial study (`r diff_lang`%). 
