...
On the other hand it has been claimed that we should take a more critical approach with respect to a study's construct validity when deciding whether it is worth to be replicated. According to this view, resources can be saved if studies with poor experimental design, unsuitable measurement approach or inept model specifications are not attempted to be replicated [@yarkoni2019generalizability].
