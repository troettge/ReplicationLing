...
Without replicating individual studies, biases caused by questionable research practices [@john2012measuring], small sample size [@button2013power] and publication bias [@fanelli2012negative] can lead to a set of studies that appear to form a coherent and converging empirical foundation of an underlying theory, even if the underlying empirical claims cannot be replicated:
